# Generated by Django 6.0.2 on 2026-02-20 23:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_url', models.URLField(blank=True, help_text='YouTube, Vimeo, or external video URL', null=True)),
        ...
        migrations.AddField(
            model_name='course',
            name='department',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='eduweb.department'),
        ),
        migrations.CreateModel(
            name='Discussion',
            fields=[
        ...
        migrations.AddField(
            ...
            name='faculty',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departments', to='eduweb.faculty'),
        ),
        migrations.AddField(
            model_name='course',
            name='faculty',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credits_required', models.IntegerField(default=120)),
                ('description', models.TextField(blank=True)),
                ('entry_requirements', models.JSONField(blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('academic_year', models.CharField(blank=True, help_text='e.g. 2024/2025', max_length=9)),
                ...
                ('program', models.ForeignKey(blank=True, help_text='Scope this payment to a specific program (optional)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='required_payments', to='eduweb.program')),
            ],
            options={
